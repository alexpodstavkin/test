  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'display-md': ['clamp(1.75rem, 4.5vw, 2.75rem)', { lineHeight: '1.05', letterSpacing: '-0.025em' }],
        'display-lg': ['clamp(1.85rem, 5.5vw, 3.5rem)', { lineHeight: '1.02', letterSpacing: '-0.03em' }],
      },
      colors: {
        canvas: '#FBFBFB',
        surface: '#F1F1F1',
        ...
        cta: { 400: '#1AE89A', 500: '#00E48D', 600: '#00C97C', 700: '#00A865' },
        ink: {
          50: '#F7F7F7', 100: '#EDEDED', 200: '#D9D9D9',
          500: '#5A5A5A', 700: '#323232', 800: '#262626', 900: '#1B1B1B',
        },
        night: '#222222',
        summer: {
          sun: '#FFB740',
      ...
      borderRadius: { sm: '8px', md: '12px', lg: '15px', xl: '20px', '2xl': '20px' },
      boxShadow: {
