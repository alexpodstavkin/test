...
const stats = [
  { value: '10 000+', label: nbsp('выпускников платных программ') },
  { value: '300 млн ₽', label: nbsp('заказов через карьерный центр') },
  {
    value: '2 350+',
    label: nbsp('госслужащих и чиновников обучены в проекте «Цифровая прокачка»'),
  },
  { value: 'с 2021', label: nbsp('обучаем работе с нейросетями и no-code') },
];
      ...
      <div className="container-edge">
        <div className="mb-10 max-w-[64ch] md:mb-14">
          <h2 className="h-section">
            {nbsp(
              'Мы создаём фундаментальное образование в области искусственного интеллекта и разработки',
            )}
          </h2>
        </div>
