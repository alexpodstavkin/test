...
// ⚠️ ВРЕМЕННО: виджет взят с ленда gos-ai-urok. Владелец даёт свой ID —
// заменить обе константы ниже (id воронки в SCRIPT_SRC и якорь SCRIPT_ID),
// иначе заявки мини-курса уйдут в воронку урока gos-ai-urok.
