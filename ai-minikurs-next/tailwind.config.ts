...
const config: Config = {
  ...
  theme: {
    extend: {
      // Автомасштаб (components/AutoScale.tsx) выключен до 860px включительно.
      // Совмещаем с ним точку md, иначе в полосе 768–860 включаются десктопные
      // сетки без масштаба и ряды схлопываются.
      screens: { md: '861px' },
      colors: {
      ...
      fontFamily: {
        // Manrope — единственный шрифт лендинга (канон Зерокодера).
