...
import './globals.css';
import '../vendor-uicons/regular/rounded.css';
...
export const metadata: Metadata = {
  title: 'Всероссийская программа подготовки детей «Профессии будущего: Погружение в искусственный интеллект» — бесплатный урок по нейросетям',
  description:
